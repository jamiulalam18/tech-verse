...
const UpdateProductForm = ({ product }) => {
  ...
  const handleUpdateProduct=(e)=>{
    ...
    const updated_product={brand_name,product_name,product_category,product_image,product_highlights,product_price,product_rating,product_short_description,product_long_description}
  ...
  return (
    <div className="bg-white flex justify-center w-full rounded-lg">
      <form onSubmit={handleUpdateProduct} className="flex max-w-md flex-col gap-2 w-full py-4 rounded-lg">
        <div>
          <div className="max-w-md" id="select">
            <div className=" block">
              <Label htmlFor="brand_name" value="Select Brand" />
            </div>
            <Select id="brand_name" name="brand_name" defaultValue={brand_name} required>
        ...
        <div>
          <div className="max-w-md" id="select">
            ...
            <Select id="product_category" name="product_category" required defaultValue={product_category}>
        ...
        <div>
          <div className="max-w-md" id="product_highlights">
            ...
            <Textarea
              ...
              required
              rows={4}
              defaultValue={product_highlights}
            />
          </div>
        </div>
