      ...
      <form className="flex max-w-md flex-col gap-2 w-full py-4 rounded-lg">
        <div>
          <div className="max-w-md" id="select">
            ...
            <Select id="brand_name" required>
              ...
              <option selected>{brand_name}</option>
            </Select>
          </div>
        </div>
        ...
        <div>
          <div className="max-w-md" id="textarea">
            ...
            <Textarea
              ...
              placeholder={product_short_description}
              required
              rows={2}
            />
          </div>
        ...
        <div>
          <div className="max-w-md" id="textarea">
            ...
            <Textarea
              id="long_description"
              placeholder={product_long_description}
              required
              rows={4}
            />
          </div>
        ...
        <div>
          <div className="max-w-md" id="textarea">
            ...
            <Textarea
              ...
              placeholder={product_highlights}
              required
              rows={4}
            />
          </div>
